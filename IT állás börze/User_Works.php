...
<div id="Header" class="container-fluid">
    ...
    <div id="HeaderButton">
        <div><a href="User_identification%20.php"><input id="b3" type="button" value="Saját adataim"></a></div>
                            ...
                            <td class="Whitin-td">
                                <table class="Within-table-table">
                                    ...
                                    <tr class="Whitin-tr-tr"><td class="Whitin-td-td"><center>
                                            ...
                                            <?php  ?>
                                            <a href="User_working.php"  class="within-href"><input id="Select" type="button" value="Munkára"></a>
                                            </center>
                                            <?php
                                            $next = $dates['work_id'];
